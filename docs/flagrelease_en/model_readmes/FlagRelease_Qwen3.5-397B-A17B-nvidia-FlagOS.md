...
# Evaluation Results
## Benchmark Result
|Metrics|Alibaba Tongyi's Report|Qwen3.5-397B-A17B-Nvidia-Origin|Qwen3.5-397B-A17B-FlagOS|
|-------|--------------|---------------|---------------|
|ERQA(vision)|67.5 |65.28|65.28|
|AIME(Text) |91.3(2026) | 90(2024)|100.0(2024)|
...
### Serve
```bash
vllm serve /data/Qwen3.5-397B-A17B --port 9010 --served-model-name qwen35-flagos --tensor-parallel-size 8 --max-num-batched-tokens 16384 --max-num-seqs 2048 --reasoning-parser qwen3
```
