...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-metax-release-model_qwen3-8b-tree_none-gems_3.0-scale_0.8.0-cx_none-python_3.10.10-torch_2.6.0_metax3.0.0.3-pcp_maca3.0.0.8-gpu_metax001-arc_amd64-driver_3.3.12:260211
```
...
docker run -d -it --net=host --uts=host --ipc=host -e USE_FLAGGEMS=1 \
            ...
            --name flagos harbor.baai.ac.cn/flagrelease-public/flagrelease-metax-release-model_qwen3-8b-tree_none-gems_3.0-scale_0.8.0-cx_none-python_3.10.10-torch_2.6.0_metax3.0.0.3-pcp_maca3.0.0.8-gpu_metax001-arc_amd64-driver_3.3.12:260211 bash
```
