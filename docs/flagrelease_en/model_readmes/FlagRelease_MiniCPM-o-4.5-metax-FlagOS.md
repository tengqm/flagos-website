...
Based on this, the **MiniCPM-o-4.5-metax-FlagOS** model is adapted for the Hygon chip using the FlagOS software stack, enabling:
...
Accuracy Difference between using FLAGOS and Metax on Nvidia-CUDA
